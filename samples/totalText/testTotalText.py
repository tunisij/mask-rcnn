...
MODEL_PATH = os.path.join('', "mask_rcnn_totaltext_0001.h5")
...
model = modellib.MaskRCNN(mode="inference", model_dir='mask_rcnn_totaltext_0001.h5', config=config)
model.load_weights('mask_rcnn_totaltext_0001.h5', by_name=True)

class_names = ['BG', 'totalText']

# Load a random image from the images folder
sample = 'C:/Users/tunis/PycharmProjects/Mask_RCNN/samples/totalText/data/train/img90.jpg'
